...
func (greenTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0xd2, G: 0xfe, B: 0xd1, A: 0xf3}
...
func (greenTheme) Size(s fyne.ThemeSizeName) float32 {
	switch s {
