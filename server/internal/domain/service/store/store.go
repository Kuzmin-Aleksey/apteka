...
type StoreRepo interface {
	New(ctx context.Context, store *entity.Store) error
...
func (s *StoreService) NewStore(ctx context.Context, store *entity.Store) error {
...
func (s *StoreService) GetAll(ctx context.Context) ([]entity.Store, error) {
